wd='C:/Users/86137/OneDrive/Desktop/nature_genetics/figures/codes for figure 4/panel g'
setwd(wd)
getwd()
list.files()
...
x <- readLines("Kosinski_CryptTopAndBottom_GeneSetList.gmt")
res <- strsplit(x, "\t")
#将x按"\t"分割符分割，生成一列表。
...
for(i in 1:length(data_1)){
  ...
  #paths=names(res)
  paths=c("Kosinski_CryptBottom.signature", "Kosinski_CryptTop.signature")
